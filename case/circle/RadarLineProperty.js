 ...
 */
export class RadarLineProperty {
  constructor(options) {
  ...
  equals(other) {
    return (this === other ||
      (other instanceof RadarLineProperty &&
...
Object.defineProperties(RadarLineProperty.prototype, {
  color: Cesium.createPropertyDescriptor('color'),
  speed: Cesium.createPropertyDescriptor('speed')
})

Cesium.RadarLineProperty = RadarLineProperty;
Cesium.Material.RadarLineProperty = 'RadarLineProperty';

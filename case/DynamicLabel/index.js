...
export class DomLabelDemo {
  constructor(viewer) {
    ...
    new DynamicLabel(viewer, [116.4715397068917, 39.9945712104195, 0.1], ['位置1',"力博荣"], "style2");
    new DynamicLabel(viewer, [116.4825397068917, 39.9645712104195, 0.1], ['位置2', "测试"], "style2");

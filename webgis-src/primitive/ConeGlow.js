...
import { IMG_PARTICLES } from '../misc/ImageParticles'
import '../material/circle'
import '../material/cylinder'

window.Cesium = Cesium;
export class ConeGlow {
  constructor({ viewer, color, center, length, topRadius, bottomRadius }) {
    this._center = center;
    ...
    this._style = {
      color: color || Cesium.Color.ORANGE

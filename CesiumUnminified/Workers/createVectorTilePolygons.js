...
define(['./AttributeCompression-8ef010ad', './Matrix2-05c3b15c', './Color-de4ac8ab', './defaultValue-9e6a554b', './IndexDatatype-0f0fb6e9', './ComponentDatatype-356d7ba7', './OrientedBoundingBox-34f5b474', './createTaskProcessorWorker', './RuntimeError-7d2f06a8', './Transforms-95ed856e', './_commonjsHelpers-f492e1ba', './combine-e8ef3dac', './WebGLConstants-f98c7b4b', './EllipsoidTangentPlane-8463228c', './AxisAlignedBoundingBox-b0c145c8', './IntersectionTests-2bd77227', './Plane-b3eeaae0'], (function (AttributeCompression, Matrix2, Color, defaultValue, IndexDatatype, ComponentDatatype, OrientedBoundingBox, createTaskProcessorWorker, RuntimeError, Transforms, _commonjsHelpers, combine, WebGLConstants, EllipsoidTangentPlane, AxisAlignedBoundingBox, IntersectionTests, Plane) { 'use strict';

...
define(['./AxisAlignedBoundingBox-b0c145c8', './Transforms-95ed856e', './Matrix2-05c3b15c', './defaultValue-9e6a554b', './TerrainEncoding-db818dc5', './ComponentDatatype-356d7ba7', './OrientedBoundingBox-34f5b474', './RuntimeError-7d2f06a8', './WebMercatorProjection-b5a49962', './createTaskProcessorWorker', './_commonjsHelpers-f492e1ba', './combine-e8ef3dac', './AttributeCompression-8ef010ad', './WebGLConstants-f98c7b4b', './EllipsoidTangentPlane-8463228c', './IntersectionTests-2bd77227', './Plane-b3eeaae0'], (function (AxisAlignedBoundingBox, Transforms, Matrix2, defaultValue, TerrainEncoding, ComponentDatatype, OrientedBoundingBox, RuntimeError, WebMercatorProjection, createTaskProcessorWorker, _commonjsHelpers, combine, AttributeCompression, WebGLConstants, EllipsoidTangentPlane, IntersectionTests, Plane) { 'use strict';

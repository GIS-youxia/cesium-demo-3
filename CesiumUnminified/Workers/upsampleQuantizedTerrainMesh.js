...
define(['./AttributeCompression-8ef010ad', './Transforms-95ed856e', './Matrix2-05c3b15c', './defaultValue-9e6a554b', './TerrainEncoding-db818dc5', './IndexDatatype-0f0fb6e9', './RuntimeError-7d2f06a8', './ComponentDatatype-356d7ba7', './OrientedBoundingBox-34f5b474', './createTaskProcessorWorker', './_commonjsHelpers-f492e1ba', './combine-e8ef3dac', './WebGLConstants-f98c7b4b', './EllipsoidTangentPlane-8463228c', './AxisAlignedBoundingBox-b0c145c8', './IntersectionTests-2bd77227', './Plane-b3eeaae0'], (function (AttributeCompression, Transforms, Matrix2, defaultValue, TerrainEncoding, IndexDatatype, RuntimeError, ComponentDatatype, OrientedBoundingBox, createTaskProcessorWorker, _commonjsHelpers, combine, WebGLConstants, EllipsoidTangentPlane, AxisAlignedBoundingBox, IntersectionTests, Plane) { 'use strict';

...
define(['./Matrix2-05c3b15c', './AxisAlignedBoundingBox-b0c145c8', './Transforms-95ed856e', './defaultValue-9e6a554b', './RuntimeError-7d2f06a8', './TerrainEncoding-db818dc5', './ComponentDatatype-356d7ba7', './OrientedBoundingBox-34f5b474', './WebMercatorProjection-b5a49962', './_commonjsHelpers-f492e1ba', './createTaskProcessorWorker', './combine-e8ef3dac', './AttributeCompression-8ef010ad', './WebGLConstants-f98c7b4b', './EllipsoidTangentPlane-8463228c', './IntersectionTests-2bd77227', './Plane-b3eeaae0'], (function (Matrix2, AxisAlignedBoundingBox, Transforms, defaultValue, RuntimeError, TerrainEncoding, ComponentDatatype, OrientedBoundingBox, WebMercatorProjection, _commonjsHelpers, createTaskProcessorWorker, combine, AttributeCompression, WebGLConstants, EllipsoidTangentPlane, IntersectionTests, Plane) { 'use strict';
